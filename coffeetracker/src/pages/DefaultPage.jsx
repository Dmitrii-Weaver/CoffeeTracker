        ...
        <Flex minH={"100vh"} justifyContent={"center"} alignItems={"center"} backgroundColor={"#856852"}>
            <Container maxW={"container.md"} padding={0}>
                <Flex flexDirection={"row"} justifyContent={"space-around"} alignItems={"center"}>
                    <Flex borderRadius={5} borderColor={'black'} padding={5} border={"1px solid"} background={"#C5A880"} flexDirection={"column"} alignItems={"center"} justifyContent={"center"}>
                    ...
                    <Flex Flex borderRadius={5} borderColor={'black'} padding={5} border={"1px solid"} background={"#C5A880"} flexDirection={"column"} alignItems={"center"} justifyContent={"center"}>
                        <Text>
                            Log in to track!
                        </Text>
                        <VStack>
